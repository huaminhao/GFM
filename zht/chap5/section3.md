...
輔以具體數字說明，假設折算時進取份額淨值為0.250元，穩健份額淨值為1.000元，並且折算前的老銀華中證母基金的份額為10,000份，淨值為0.675元（進取、穩健份額各5,000份）折算後，進取份額淨值提升至1元，份額相應縮減至1,250份，穩健份額為了保持與進取份額的1:1配比，且淨值為1元，則5,000份老穩健份額中的1,250份繼續留在場
內，其餘的3,750份折算成3,750份淨值為1元的新銀華中證母基金
